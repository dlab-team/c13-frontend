...
export default function creditos() {
  let teamMembers = [
...

    {
      ...
      linkedInUrl:
        "https://www.linkedin.com/in/gast%C3%B3n-dami%C3%A1n-toledo-becerra-0b6aa8266/",
...

    {
      ...
      linkedInUrl:
        "https://www.linkedin.com/in/javier-arroyo-guerra-80232b212/",
    ...
    },
    {
      ...
      linkedInUrl:
        "https://www.linkedin.com/in/leonardo-josé-castillo-lacruz-4911571a/",
...

    {
      ...
      linkedInUrl: "https://www.linkedin.com/in/giancarlonoseda",
      imageRed: "/images/logo_github.png",
    },
  ];
  ...
  const shuffledMembers = teamMembers
    ...
    .concat(
      teamMembers.filter((member) => member.id === 10 || member.id === 11)
    );
