		...
		<>
			<div className="container">
				<div className="text-center my-5 ">
					<button
						className="btn btn-secondary mx-2 align-items-center justify-content-center"
						style={{
							background: "#739e2d",
							borderRadius: "50px",
							width: "630px",
					...
					>
						<Link href="/categorias/javascript">
							<p className={styles.javascriptLink}>pJavaScript</p>
						</Link>
					</button>
					<button className="btn btn-secondary rounded-100 w-50">Básico</button>
				</div>
